...
export const DEMO_OVO = {
  ...
  brand: {
    ...DEFAULT_BRAND,
    name: "Holisto",
    alt_names: ["Holisto", "Holisto Online"],
    legal_name: "Holisto Commerce Inc.",
    slogan: "Everyday essentials, delivered.",
    description:
      "Holisto is a demo storefront used to showcase the OVO plugin.",
  },
  default_meta: {
    ...DEFAULT_META,
    title_default: "Holisto",
    title_template: "%s | Holisto",
    description_fallback: "Holisto — a demo storefront for the OVO plugin.",
    keywords: ["holisto", "demo store", "online visibility"],
  },
  entity: {
  ...
  generative: {
    ...
    summary_paragraph:
      "Holisto is a demo brand used to illustrate the OVO plugin's GEO/AEO surfaces.",
